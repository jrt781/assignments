...
object ServerRootModel {
	...
	private fun initCS330() {
		val course = Course("CS 330", "Concepts of Programming Languages", "Bryan Morse", Color.GREEN)
		
		courses.add(course)
		
		course.assignments.add(Assignment("Basic Racket", course.id, Date(10, 9, 2018), Time(11, 59, Meridian.PM)))
		course.assignments.add(Assignment("Lists and Recursion", course.id, Date(14, 9, 2018), Time(11, 59, Meridian.PM)))
		course.assignments.add(Assignment("First-class and higher-order functions", course.id, Date(19, 9, 2018), Time(11, 59, Meridian.PM)))
		course.assignments.add(Assignment("More Higher-Order Functions", course.id, Date(21, 9, 2018), Time(11, 59, Meridian.PM)))
		course.assignments.add(Assignment("Interpreter 1", course.id, Date(1, 10, 2018), Time(11, 59, Meridian.PM)))
		course.assignments.add(Assignment("Interpreter 2", course.id, Date(12, 10, 2018), Time(11, 59, Meridian.PM)))
		course.assignments.add(Assignment("Interpreter 3", course.id, Date(19, 10, 2018), Time(11, 59, Meridian.PM)))
		course.assignments.add(Assignment("Logic Puzzle 1 - Rosie's Roses", course.id, Date(26, 10, 2018), Time(11, 59, Meridian.PM), "Use the template code to begin this project."))
	...
	private fun initSFL110() {
		...
		course.assignments.add(Assignment("Quiz - Introduction Video", course.id, Date(18, 9), Time(10, 0, Meridian.PM), "Closed book, no notes."))
		course.assignments.add(Assignment("Quiz - SFL 110 Learning Suite and Syllabus", course.id, Date(18, 9), Time(10, 0, Meridian.PM), "Closed book, no notes."))
		course.assignments.add(Assignment("Quiz - Ch. 1, 2, and 20 - Food for Today, Food and Nutrition, and Menu Planning and Meal Preparation", course.id, Date(18, 9), Time(10, 0, Meridian.PM), "Closed book, no notes."))
		course.assignments.add(Assignment("Quiz - Ch. 3 & 4 - Food Safety and Factors in Food Preparation", course.id, Date(25, 9), Time(10, 0, Meridian.PM), "Closed book, no notes."))
		course.assignments.add(Assignment("Quiz - Ch. 5 & 6 - Vegetables, Fruits, and Preservation", course.id, Date(2, 10), Time(10, 0, Meridian.PM), "Closed book, no notes."))
		course.assignments.add(Assignment("Quiz - Ch. 8 - Fats and Oils", course.id, Date(9, 10), Time(10, 0, Meridian.PM), "Closed book, no notes."))
		course.assignments.add(Assignment("Quiz - Ch. 11 - Proteins: Milk and Cheese", course.id, Date(16, 10), Time(10, 0, Meridian.PM), "Closed book, no notes."))
		course.assignments.add(Assignment("Quiz - Ch. 13 - Meat, Poultry, and Fish", course.id, Date(23, 10), Time(10, 0, Meridian.PM), "Closed book, no notes."))

		val assignment = Assignment("Midterm", course.id, Date(30, 10), Time(10, 0, Meridian.PM))
		assignment.addTag(Tag("Exam"))
		course.assignments.add(assignment)

		course.assignments.add(Assignment("Quiz - Ch. 12 - Eggs", course.id, Date(30, 10), Time(10, 0, Meridian.PM), "Closed book, no notes."))
		...
		course.assignments.add(Assignment("PreAssessment", course.id, Date(12, 9), Time(11, 0, Meridian.AM), "Graded on completion!"))
		course.assignments.add(Assignment("Magnificent Meal Individual Menu, Recipes, & Cost ", course.id, Date(12, 10), Time(12, 0, Meridian.PM), "Use the spreadsheets on the class website."))
		course.assignments.add(Assignment("Writing Assignment 1", course.id, Date(17, 10), Time(11, 0, Meridian.AM)))
	...
	private fun initNDFS100() {
		...
		course.assignments.add(Assignment("Group Consensus Report", course.id, Date(25, 9), Time(1, 35, Meridian.PM), "Only one person in your group has to submit.\nSubmit in class or on Learning Suite."))
		course.assignments.add(Assignment("Plan and Prepare a Meal", course.id, Date(19, 10), Time(1, 35, Meridian.PM), "Make sure to take a picture and include it in your report!"))
